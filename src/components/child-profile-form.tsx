  ...
  return (
    <form action={submit} className="grid gap-5">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div className="grid gap-2"><Label htmlFor="gender">Gender</Label><select id="gender" name="gender" required className="h-8 rounded-lg border border-input bg-transparent px-2.5 text-sm text-foreground outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"><option value="">Select</option><option value="male">Male</option><option value="female">Female</option><option value="other">Other / prefer not to say</option></select></div>
      </div>
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
      ...
      <label className="flex items-center gap-3 text-sm text-foreground"><input name="bornWithJaundice" type="checkbox" className="h-4 w-4 rounded border-input accent-primary" /> Born with jaundice</label>
      <label className="flex items-center gap-3 text-sm text-foreground"><input name="familyASDHistory" type="checkbox" className="h-4 w-4 rounded border-input accent-primary" /> Family history of autism</label>
